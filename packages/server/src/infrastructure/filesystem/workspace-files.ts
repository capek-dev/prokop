 ...
 * Directory listing, search, and the ignore filter. Byte-for-byte move of
 * the pre-slice `services/files.ts` behavior: ignore-cache lifecycle,
 * fast-glob search, abort handling, ordering, and hidden handling are all
 * unchanged.
 */
